    ...
    <div class="row col-md-6 offset-md-3">
        <div class="card" style="width: 100%">
            <div class="card-header">
                <h4 style="color: cadetblue">Добавить новую тему обсуждения!</h4>
            </div>
            <div class="card-body">
                <form action="<c:url value='/save'/>" method="POST">
                    <div class="form-group">
                        <label for="name">Название</label>
                        <input type="text" required class="form-control" name="name" title="Enter name..." id="name" value="${post.name}">
                    </div>
                    <div class="form-group">
                        <label for="desc">Описание</label>
                        <input type="text" required class="form-control" name="desc" title="Enter desc..." id="desc" value="${post.desc}">
                    </div>
